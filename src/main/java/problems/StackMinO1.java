...
/**
 * 1. Program to create a stack , add one more method to it getMin() : which
 * gives the minimum of stack at given point in time but with time complexity
 * O(1)
 * 
 ...
 * peek - Get the item at top of the stack - push - Push the item to top of the
 * stack - pop - Remove the top item from the stack - getMin - Get the minimum
 * item from the stack with complexity O(1)
 *
 */
class StackImpl {
